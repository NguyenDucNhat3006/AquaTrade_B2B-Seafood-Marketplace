                  ...
                  <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
                    lock
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-12 pr-12 py-3.5 bg-white border rounded-xl focus:ring-2 outline-none transition-all ${
                                            error
                                                ? "border-red-500 focus:ring-red-200 focus:border-red-500"
                                                : "border-gray-300 focus:ring-teal-200 focus:border-teal-500"
                                        }`}
                    ...
                    <span className="material-symbols-outlined">
                      {showPassword ? "visibility_off" : "visibility"}
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className={`w-full py-4 text-white font-semibold rounded-xl shadow-lg transition-all flex items-center justify-center gap-2 ${
                                    success
                                        ? "bg-green-500"
