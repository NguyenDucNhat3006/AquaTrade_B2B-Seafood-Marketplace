...
import {
  ...
  Home, ArrowRightLeft, Navigation, Search, Bell, ArrowLeft
} from "lucide-react";
import {
        ...
        <div className="flex-1 overflow-auto bg-slate-50 p-6">
          <div className="max-w-6xl mx-auto space-y-7">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3">
              <div>
                <button onClick={() => navigate('/exchange')} className="flex items-center gap-1.5 text-teal-600 hover:text-teal-700 text-sm font-bold mb-2 transition-colors inline-flex w-fit">
